#' @title Hoeffding trees Probabilities
#'
#' @description
...
hoeffding_tree_probabilities <- function(input_model,
                                         test,
                                         test_labels = NA,
                                         verbose = getOption("mlpack.verbose", FALSE)) {
  # Create parameters and timers objects.
  p <- CreateParams("hoeffding_tree_probabilities")
  t <- CreateTimers()
  ...
  # Call the program.
  hoeffding_tree_probabilities_call(p, t)
