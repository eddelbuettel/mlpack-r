/**
 * @file src/bayesian_linear_regression_train.cpp
 *
 * This is an autogenerated file containing implementations of C++ functions to
 * be called by the R bayesian_linear_regression_train binding.
 */
#include <rcpp_mlpack.h>
#define BINDING_TYPE BINDING_TYPE_R
#include <mlpack/methods/bayesian_linear_regression/blr_train_main.cpp>
