/**
 * @file src/bayesian_linear_regression_predict.cpp
 *
 * This is an autogenerated file containing implementations of C++ functions to
 * be called by the R bayesian_linear_regression_predict binding.
 */
#include <rcpp_mlpack.h>
#define BINDING_TYPE BINDING_TYPE_R
#include <mlpack/methods/bayesian_linear_regression/blr_predict_main.cpp>
